...
int acceler_Init()
{
    int ans ;
     ...
     ans = register_read(0x00) ;
     if (ans == 0xE5) {
          register_write(0x2C,0x0B) ;
          register_write(0x31,0x11) ;
          register_write(0x38,0x00) ;
          register_write(0x2D,0x08) ;
          _delay((unsigned long)((2000)*(16000000/4000000.0))) ;
     } else ans = -1 ;
     return ans ;
}
